<?php
    ...
    include '../navbar.php';
    include 'product-list-farmer-logic.php';
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-3 mb-3 d-flex justify-content-between align-items-center">
        <h2 class="text-success">Your Products</h2>
        <a class="app-product-btn btn d-flex align-items-center" href="add-product.php"><i class="fa fa-plus me-2"></i>Add Product</a>
    </div>
        <div class="row row-cols-1 row-cols-md-5 g-5">
            ...
            <!-- <div class="col">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text"><b><i class="fa fa-inr" aria-hidden="true"></i> 200/</b><span class="text-muted"> Ton</span></p>                    
                    <hr>
                    <div class="buttons">
                        <button type="button" class="btn btn-outline-warning w-100 ">Edit</button>
                        <button type="button" class="btn btn-outline-danger w-100 mt-2">Delete</button>
                    </div> 
                </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 mi-card">
                    <div class="imagecover">
                <img src="https://www.indoasiancommodities.com/wp-content/uploads/2016/01/Cotton-field-720x540.jpg" class="card-img-top productImage" alt="...">
                </div>
                <div class="card-body">
                    <h5 class="card-title fw-bold">Cotton</h5>
                    <p class="card-text"><b><i class="fa fa-inr" aria-hidden="true"></i> 200/</b><span class="text-muted"> Quintal</span></p>                    
                    <hr> 
                    <div class="buttons">
                        <button type="button" class="btn btn-outline-warning w-100 ">Edit</button>
                        <button type="button" class="btn btn-outline-danger w-100 mt-2">Delete</button>
            ...
            <!-- <div class="col">
                <div class="card h-100 mi-card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="buttons">
                            <button type="button" class="btn btn-outline-warning w-100 " h>Edit</button>
                            <button type="button" class="btn btn-outline-danger w-100 mt-2">Delete</button>
                        </div> 
                    </div>
                </div>
